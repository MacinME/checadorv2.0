...
export const DashboardSubjectCard = ( { data, degree }) => {
  return (
    <div className="col-span-2 flex items-center flex-col h-full bg-white rounded-lg dark:bg-dark-700">
        <div className="w-full bg-white dark:bg-dark-700 h-auto to-yellow-800 rounded-tl-lg rounded-tr-lg py-5 relative hover:bg-gray-200 dark:hover:bg-gray-800 cursor-pointer">
