                        ...
                        <div className="xl: xl:w-full xl:justify-start xl:gap-3 py-2 px-2">
                            {   
                                item.subjects.map( (subject, index) => (
                                    <div key={ index } className="xl:flex flex-col border dark:border-gray-800 rounded-lg md:mb-2 sm:mb-2 hover:bg-gray-200 dark:hover:bg-gray-700 cursor-pointer">
                                        <p className="text-gray-200 w-full text-center">{ subject.subject }</p>
