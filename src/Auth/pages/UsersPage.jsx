  ...
  return (
      <div className="container ">
        <div className="title flex items-center mb-10">
          <h1 className="font-bold text-2xl text-gray-800">Personal Registrado <span className="bg-primary text-sm px-2 py-1 text-white rounded rounded-3xl font-normal">100 usuarios</span> </h1>
        </div>
          {/* Search Field  */}
