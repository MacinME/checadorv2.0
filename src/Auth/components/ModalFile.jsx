import { HiFolder, HiOutlineSave, HiOutlineUpload, HiX } from "react-icons/hi"

export const ModalFile = ({ handleModal, status }) => {

  return (
    <div className="file-modal w-screen h-screen absolute flex justify-center items-center rounded-2xl bg-white">
