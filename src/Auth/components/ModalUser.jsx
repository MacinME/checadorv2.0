        ...
        <div className="modal-container rounded-2xl w-screen bg-white my-5 mx-10 flex justify-between relative overflow-hidden">
          ...
          <div className="w-1/3 rounded-tl-2xl rounded-bl-2xl bg-white">
              ...
              <div className="users-section flex flex-col gap-3 p-8 overflow-y-scroll h-full text-gray-800">
                    {
                      users.map( user => (
                        <div key={ user.id } className="users-section-profile flex gap-4 items-center hover:bg-blueColor-50 rounded-full cursor-pointer transition-all">
          ...
          <div className="user-settigns flex flex-col w-full rounded-tr-2xl rounded-br-2xl px-16 overflow-y-scroll">
            {/* Form Component */}
